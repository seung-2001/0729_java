...
public class F_Logical {
	 ...
	 * 
	 * 2.OR연산자 : 논리값 ||논리값
	 * 좌항과 우항 값 중 하나라도 true일 경우 최종 결과값이 true
	 */
	// AND
	...
	public void method1() {
		...
		// 사용자가 입력한 정수가 0보다 크고 그리고 사용자가 입력한 정수를 2로 나눴을 때 나머지가 0인가요?
		
		System.out.printf("입력 값이 0보다 크면서 짝수 입니까? : %b", result);
	}
	...
	public void method2() {
		...
		System.out.println("1 ~ 100 사이의 값입니까? : " + result);
	}
