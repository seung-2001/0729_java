...
public class C_Switch {
	 ...
	 * break;
	 * case 값n : 실행할코드n; // 동등비교대상 == 값n true일 경우 실행할코드 n를 수행
	 * break;
	 * default : 실행할 코드; // == else
	 * }
	 */
	...
	public void method1() {
		...
		case "수제비","제육" : System.out.println("7000원 입니다."); break;
	...
	public void login() {
		...
		// 사용자가 로그인 시 입력한 비밀번호 값과 회원가입 시 가입한 비밀번호 값이 동이하다면
