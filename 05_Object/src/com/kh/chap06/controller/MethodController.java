...
public class MethodController {
	 ...
	 * 
	 * 프로그래밍 언어에서 함수 : 특정 작업을 수행하기 위해서 만들어진 코드 블록 
	 * 1. 재사용성 
	 * 2. 모듈화
	 * 
	 * 객체지향 프로그래밍에서 메소드란 : 객체가 수행할 수 있는 행동을 정의한 코드 블록
	 * 
	...
	public void method1() {
		...
		// return;
		// return Type이 void일 경우 return문을 생략 할 수 있다.
	}
