...
public class Casting {
	 ...
	 * => 자료형이 다른데 연산이 하고싶다?? 둘 중 하나를 "형변환"해서 나머지 하나와 동일하게 맞춤
	 * 
	 ...
	 * 		직접 형변환을 할 필요가 없음
	 * 
	 * 2. 강제형변환(Type Casting) : 자동형변환 이루어지지 않는 경우 진행
	 * 		
	...
	public void autoCasting() {
		//System.out.println("이 내용을 콘솔창에 출려해보세요 실습 시작!");
		...
		// 3. long(정수, 48Byte) => float(실수, 4Byte) ** 특이케이스
		...
		System.out.println((int)'2' == '2');//false
