...
public class Array {
	...
	public void method1() {
		...
		/*
		 * 배열에 몇 개의 값이 들어갈지 배열의 크기를 정해주는 과정 지정한 개수만큼 들어갈 공간이 할당됨
		 * 
		 * [ 표현법 ] int[] numbers; // 배열선언 numbers = new int[]; // 할당
		 * 
	...
	public void methodA() {
		 ...
		 * System.out.println("종로점 주소 : " + KH정보교육원종로지원); KH정보교육원종로지원[0] = "인포";
	...
	public void methodB() {
		...
		animals[3] = "호랑이";
		animals[4] = "코끼리";
		// animals[5] = "티라노사우루스"; <-- 문법적으로는 문제가 없음
	...
	public void methodC() {
		...
		int[] num = new int[3];
		/*
		 * System.out.print("첫번째 정수를 입력해주세요 > "); number[0] = sc.nextInt();
		 * sc.nextLine();
		 * 
		 * System.out.print("두번째 정수를 입력해주세요 > "); number[1] = sc.nextInt();
		 * sc.nextLine();
		 * 
		 * System.out.print("세번째 정수를 입력해주세요 > "); number[2] = sc.nextInt();
		 * sc.nextLine();
		 */
		...
		System.out.println("배열의 요소 중 가장 작은 값" + result);
