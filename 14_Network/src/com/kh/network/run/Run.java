...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * MAC(Media Access Controler) Adress / IP(Internet Protocol) Address
		 * 
		...
		try {
			...
			// getLocalHost:() : 현재 작업하고 있는 Host의 정보를 반환해주는 메소드
		 ...
		 * => 무조건 응답 결과를 돌려 주어야함
		 * 
		 * "요청(request)"과 "응답(response)"으로 프로그램이 동장(통신)함
